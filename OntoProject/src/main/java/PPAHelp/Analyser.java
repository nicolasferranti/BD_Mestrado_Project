...
import ontoManager.SimilarityVO;
...
//            if (!file.exists()) {
//                throw new IOException("Arquivo de alinhamento não encontrado");
//            }
//
...
//        }
        ...
        processaSimilaridades(conceitos1, conceitos2);
    ...
    private void processaSimilaridades(List<OntResource> conceitos1, List<OntResource> conceitos2) {
        float zero = 0;
            ...
            if (c1.getLocalName() != null) {
                ...
                for (Iterator i2 = conceitos2.iterator(); i2.hasNext();) {
                    ...
                    if (possuiMesmoTipo(c1, c2) && c2.getLocalName() != null) {
                        ...
                        similarityVO.addSimilarity(zero);
